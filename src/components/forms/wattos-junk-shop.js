            ...
            >
                <div className="page-content-wrapper normal" >
                    <div className="content-wrapper">
                        ...
                        <div class='result'>
                                <p>If you're <span>{`${this.state.verbing1}`}</span> in the Outer Rim Territories and you need spare <span>{`${this.state.pluralNoun1}`}</span> for your space-<span>{`${this.state.noun1}`}</span> or other odds and <span>{`${this.state.pluralNoun2}`}</span>, the place to go is Watto's Junk Shop. Here you can find everything from robots that jump like Mexican <span>{`${this.state.verbing2}`}</span> beans to replacement wires for your <span>{`${this.state.adjective1}`}</span> droid so that it can <span>{`${this.state.verb}`}</span> until it blows a/an <span>{`${this.state.noun2}`}</span>. Be careful what kind of money you have in your <span>{`${this.state.noun3}`}</span> because Watto doesn't take Republic <span>{`${this.state.pluralNoun3}`}</span>. You may have to barter with something <span>{`${this.state.adjective2}`}</span> that you own. The greedy and <span>{`${this.state.adjective3}`}</span> Watto would love to get his grimy <span>{`${this.state.bodyPartPlural}`}</span> on anything that's precious to you. And don't even think about using a Jedi mind trick on Watto -- when he says something costs ten <span>{`${this.state.pluralNoun4}`}</span>, you'd better pay up, or he'll raise the price to <span>{`${this.state.number}`}</span> <span>{`${this.state.pluralNoun4}`}</span>!</p>
                            <div className="buttons">
